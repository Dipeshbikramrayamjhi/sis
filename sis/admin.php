<?php
  ...
  if(isset($_POST['login']) && $_POST['login']=='Login'){
    ...
    $result=$obj->Select("tlb_login join tbl_student on tbl_student.sid=tlb_login.sid","*","tlb_login.email",$_POST['email']," AND password='".md5($_POST['password'])."'");
    $row=mysqli_fetch_assoc($result);
    // print_r($row);
    // die;
    $rows=mysqli_num_rows($result);
    if($rows>0){
      $_SESSION['admin_login']="successful";
      ...
      <div class="row">
        <div class="col-sm-6 login-section-wrapper" style="background-color: pink ;">
          ...
          <div class="login-wrapper my-auto">
            <h1 class="login-title">Student Log in</h1>
            ...
            <a href="../new_project/superadmin.php">ADMISTRATION LOGIN PAGE</a>
