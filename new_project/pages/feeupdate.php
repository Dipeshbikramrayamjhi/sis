...
$Result=$obj->Select("tlb_fee","*","fid",$_GET['fid']);
if(isset($_POST['submit'])){
    array_pop($_POST);
    $obj->update("tlb_fee",$_POST,"fid",$_GET['fid']);
...
<select name="roll_no" class="form-control" value="<?=$row['roll_no'];?>" id="rollno" >
...
<div class="form-group">
<label for="paid_admission_fee"> PAID ADMISSION FEE</label>
...
<input type="number" name="paidfee" class="form-control">
</div>
<div class="form-group">
